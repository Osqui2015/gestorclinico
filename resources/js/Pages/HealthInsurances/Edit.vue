...
const form = useForm({
    name: props.insurance.name,
    code: props.insurance.code || "",
    phone: props.insurance.phone || "",
    email: props.insurance.email || "",
    copay_amount: props.insurance.copay_amount ?? "",
    copay_percentage: props.insurance.copay_percentage ?? "",
    requires_authorization: props.insurance.requires_authorization,
    is_active: props.insurance.is_active,
    notes: props.insurance.notes || "",
});

const submit = () => {
    form.patch(route("health-insurances.update", props.insurance.id));
};
</script>

<template>
    <Head :title="`Editar ${insurance.name}`" />
    <AuthenticatedLayout>
        <div class="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            >
                ...
                >
                    <Link
                        :href="route('health-insurances.show', insurance.id)"
